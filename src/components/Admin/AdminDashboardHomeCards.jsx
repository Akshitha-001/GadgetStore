...
const AdminDashboardHomeCards = ({ products, orders, users }) => {
    return (
        <>
            ...
            <div className=' w-full flex flex-row justify-center items-center gap-6 bg-pink-200'>
                <div className='w-1/4 h-[10vh] flex flex-row justify-center items-center px-2 shadow-md rounded-md hover:shadow-pink-200 hover:text-pink-500'>
